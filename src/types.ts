...
export interface BannerTab { id: string; name: string; title?: string; image?: string; badge?: string; order?: number; linkedProductIds?: string[]; }
export interface Banner {
  ...
  targetStyleTab?: string;
  targetTrend?: string;
  pullToRefreshTitle?: string;
  pullToRefreshSubtitle?: string;
  slideDuration?: number;
  isActive?: boolean;
  order?: number;
  subScreenTabs?: BannerTab[];
}
