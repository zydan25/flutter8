...
import { FirebaseError, getGlobal, Deferred, getModularInstance } from '@firebase/util';
...
function chromeAdapterFactory(mode, window, params) {
    ...
    const languageModel = globalObj.LanguageModel;
...
function validateGenerationConfig(generationConfig) {
    ...
    if ((generationConfig.responseSchema != null ||
        ...
        throw new AIError(AIErrorCode.UNSUPPORTED, `responseMimeType must be set to "application/json" or "text/x.enum" if` +
