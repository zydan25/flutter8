...
const GOVERNORATE_RATES: Record<string, { region: 'north'|'south'; sarToYerRate: number; usdToYerRate: number; markupValue: number; deliveryFee: number }> = {
  عدن:{region:'south',sarToYerRate:535,usdToYerRate:2040,markupValue:0,deliveryFee:0}, حضرموت:{region:'south',sarToYerRate:535,usdToYerRate:2040,markupValue:3,deliveryFee:0}, شبوة:{region:'south',sarToYerRate:535,usdToYerRate:2040,markupValue:4,deliveryFee:0}, المهرة:{region:'south',sarToYerRate:535,usdToYerRate:2040,markupValue:5,deliveryFee:0}, لحج:{region:'south',sarToYerRate:535,usdToYerRate:2040,markupValue:2,deliveryFee:0}, أبين:{region:'south',sarToYerRate:535,usdToYerRate:2040,markupValue:2,deliveryFee:0}, الضالع:{region:'south',sarToYerRate:535,usdToYerRate:2040,markupValue:3,deliveryFee:0}, سقطرى:{region:'south',sarToYerRate:535,usdToYerRate:2040,markupValue:8,deliveryFee:0},
